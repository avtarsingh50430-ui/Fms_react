...
const Updatemplans = () => {
  ...
  useEffect(() => {
    const fetchTrailerData = async () => {
      try {
        ...
        console.error("Error fetching mplans data:", error);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("mplans updated successfully!");
    } catch (error) {
      console.error("Error updating mplans data:", error);
      alert("Error updating mplans data.");
    }
  };
  return (
