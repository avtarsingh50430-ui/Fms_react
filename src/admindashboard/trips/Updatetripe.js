...
const Updatetrip = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "delivery") {
      ...
      console.log("Selected location for delivery:", selectedLocation);
      ...
      const selectedLocation = data.locations.find((item) => item.id === value);
      console.log("Selected location for pickup:", selectedLocation);
  ...
  useEffect(() => {
    axios
      .get(`https://isovia.ca/fms_api/api/updateorder/${id}`)
      .then((res) => {
  ...
  let handleonSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://isovia.ca/fms_api/api/updateorder/${id}`,
        form
      );
                          ...
                          {data &&
                            data.customers?.map((item) => (
                              <option value={item.id}>
                                {item.legal ? item.legal : item.name}
                              </option>
                            ))}
                        </select>
                      </div>
                ...
                <div className="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div className="col-md-4 col-xs-12 pull pull-left">
                    <div className="form-group">
                      ...
                      <Link to="/locations/create" className="btn btn-warning">
                        Add
                      </Link>
                    </div>
                  </div>
                        ...
                        >
                          <label>
                            ...
                            <select
                              ...
                              value={formData.manageTablestops_length}
                              onChange={handleInputChange}
                            >
                        ...
                        <tr>
                          <td>
                            <select
                              ...
                              className="form-control name_list"
                              required=""
                              value={formData.revitem}
                              onChange={handleInputChange}
                            >
                              <option value="na" disabled="" selected="">
                                Select Revenue Item
                              </option>
                              <option value="Frieght Charge">
                                Frieght Charge
                              </option>
