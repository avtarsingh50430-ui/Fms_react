    ...
    const [formData, setFormData] = useState({
      ...
      useEffect(() => {
        const fetchTrailerData = async () => {
          try {
            const response = await axios.get(`https://isovia.ca/fms_api/api/updatebrokers/${id}`);
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post(`https://isovia.ca/fms_api/api/updatebrokers/${id}`, formDataToSend, {
            headers: {
          ...
          alert('brokers updated successfully!');
        } catch (error) {
          console.error('Error updating brokers data:', error);
          alert('Error updating brokers data.');
        }
      };
  return (
