...
const Updatevendors = () => {
  ...
  useEffect(() => {
    const fetchTrailerData = async () => {
      try {
        const response = await axios.get(`https://isovia.ca/fms_api/api/updatevendors/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://isovia.ca/fms_api/api/updatevendors/${id}`, formDataToSend, {
        headers: {
  ...
  <section className="content">
      ...
      <div className="col-md-12 col-xs-12">
        ...
        <div className="box">
          <div className="box-header">
            <h3 className="box-title">Add Vendors</h3>
          </div>
          {/* /.box-header */}
          <form
            role="form"
    ...
    */}
                ...
                <div className="col-md-6 col-xs-12 pull pull-left">
                  <div className="form-group">
                    <label htmlFor="store">Factoring Company</label>
                    <select
                      className="form-control"
                      id="factoring"
                      name="factoring"
              ...
              <label for="store">Date of Birth</label>   
        ...
        */}
            ...
            Stop Notes"
              ...
              <div className="col-md-6 col-xs-12 pull pull-right">
                ...
                <div className="col-md-6 col-xs-12 pull pull-left">
                  <div className="form-group">
                    <label htmlFor="username">Refrence #</label>
                    <input
                      type="text"
                      className="form-control"
                      id="refno"
                ...
                <div className="col-md-6 col-xs-12 pull pull-left">
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                    >
                      <option value="Border Fees">Border Fees</option>
                      <option value="Vash Advance">Vash Advance</option>
                      <option value="D.E.F. Pump(Fuel)">
                        D.E.F. Pump(Fuel)
                      </option>
                      <option value="DEF">DEF</option>
                      <option value="FAX">FAX</option>
                      <option value="Fuel Expenses(Fuel)">
                        Fuel Expenses(Fuel)
                      </option>
                      <option value="Maintenance">Maintenance</option>
                      <option value="Misc">Misc</option>
                      <option value="Reefer Fuel(Fuel)">
                        Reefer Fuel(Fuel)
                      </option>
