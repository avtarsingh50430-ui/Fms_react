                    ...
                    <div className="col-md-12 col-xs-12">
                        ...
                        <div className="box">
                            <div className="box-header">
                                <h3 className="box-title">Add Documents</h3>
                            </div>
                            {/* /.box-header */}
                            <form
                                role="form"
                                        ...
                                        <div className="col-md-12 col-xs-12 pull pull-left">
                                            <div className="form-group">
                                                <select
                                                    ...
                                                    value={formData.module} onChange={handleChange}
                                                >
                                                    ...
                                                    <option value="Trip List and Planning">
                                                        Trip List and Planning
                                                    </option>
                                                    <option value="Receipt List">Receipt List</option>
                                                </select>
                                            </div>
                                            <div className="form-group">
