...
const Updatetrailors = () => {
    ...
    useEffect(() => {
        const fetchTrailerData = async () => {
            try {
                ...
                const mappedData = {
                    // Map from API response to our state names
                    plate_number: apiData.plate_number || apiData.plateno || '',
                    vin_number: apiData.vin_number || apiData.vin || '',
                    trailer_type: apiData.trailer_type || apiData.trailortype || '',
                    make: apiData.make || '',
                    model: apiData.model || '',
                    year: apiData.year || '',
                    registered_weight: apiData.registered_weight || apiData.weight || '',
                    weightunits: apiData.weightunits || 'Kilograms',
                    owner_name: apiData.owner_name || apiData.company || '',
                    country: apiData.country || 'CA',
                    province: apiData.province || apiData.state || '',
                    ...
                    ownership_type: apiData.ownership_type || 'owned',
                    owner_address: apiData.owner_address || '',
                    status: apiData.status || 'active',
                    notes: apiData.notes || apiData.remarks || '',
                    inspection_expiry: apiData.inspection_expiry || '',
                    ...
                    width: apiData.width || '',
                    widthunits: apiData.widthunits || 'Feet',
                    height: apiData.height || '',
                    heightunits: apiData.heightunits || 'Feet',
                    color: apiData.color || '',
                    gps: apiData.gps || '',
                    fleet: apiData.fleet || '',
    ...
    const handleFileChange = (e) => {
        ...
        // Clear existing image preview when new file is selected
    ...
    const handleSubmit = async (e) => {
        ...
        // Append all files (only if new files are selected)
